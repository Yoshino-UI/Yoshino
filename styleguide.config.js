...
module.exports = {
  ...
  sections: [
    ...
    {
      name: '通用组件',
      components: 'components/{Icon,Breadcrumb,Button,Card,Alert,Timeline,Backtop,Switch,Loading,Divider,Rate,Progress,Avatar,Badge,Tag,Input,InputNumber}/index.tsx',
    },
    {
      name: '特效组件',
